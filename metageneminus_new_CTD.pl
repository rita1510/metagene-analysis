...
use Data::Dumper;
use POSIX;
my @sets=("WTCHG_350045_236_R2_s","WTCHG_350045_240_R2_s");
my $binsize=20;
...
my $q=0;
my $NR = qx(wc -l $dataset.bedgraph);
open(R,"<",$dataset.".bedgraph")or die("unable to open R");
<R>;
while(my $line=<R>)
{
$q+=1/$NR;
...
open(sense_R, ">", "metagenes_final/sense_R_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open sense_R");
open(anti_R, ">", "metagenes_final/anti_R_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open anti_R");
