...
open(sense_R, ">", "metagenes_ELIFE/sense_R_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open sense_R");
open(anti_R, ">", "metagenes_ELIFE/anti_R_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open anti_R");

open(sense_Rn, ">", "metagenes_ELIFE/sense_R_".$sets[$rr]."_AsiSI_hg38_intersect_94_name")or die("unable to open sense_R");
open(anti_Rn, ">", "metagenes_ELIFE/anti_R_".$sets[$rr]."_AsiSI_hg38_intersect_94_name")or die("unable to open anti_R");
