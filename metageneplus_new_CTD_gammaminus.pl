...
open(sense_F, ">", "metagenes_final/sense_F_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open sense_F");
open(anti_F, ">", "metagenes_final/anti_F_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open anti_F");
