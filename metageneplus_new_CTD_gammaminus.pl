...
open(sense_F, ">", "metagenes_ELIFE/sense_F_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open sense_F");
open(anti_F, ">", "metagenes_ELIFE/anti_F_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open anti_F");
