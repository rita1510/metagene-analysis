...
open(sense_R, ">", "metagenes_final/sense_R_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open sense_R");
open(anti_R, ">", "metagenes_final/anti_R_".$sets[$rr]."_AsiSI_hg38_gammaminus94")or die("unable to open anti_R");
