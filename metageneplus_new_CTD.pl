...
my $q=0;
my $NF = qx(wc -l $dataset/F2_s.bedgraph);
open(F,"<",$dataset."/F2_s.bedgraph")or die("unable to open F");
<F>;
while(my $line=<F>)
{
$q+=1/$NF;
...
open(sense_F, ">", "metagenes_ELIFE/sense_F_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open sense_F");
open(anti_F, ">", "metagenes_ELIFE/anti_F_".$sets[$rr]."_AsiSI_hg38_intersect_94")or die("unable to open anti_F");
open(sense_Fn, ">", "metagenes_ELIFE/sense_F_".$sets[$rr]."_AsiSI_hg38_intersect_94_name")or die("unable to open sense_Fn");
open(anti_Fn, ">", "metagenes_ELIFE/anti_F_".$sets[$rr]."_AsiSI_hg38_intersect_94_name")or die("unable to open anti_Fn");
